                  ...
                  <div className="space-y-2.5 sm:space-y-5">
                    {currentQuestion.choices.map((choice: string, index: number) => {
                      ...
                      return (
                        ...
                        >
                          <span
                            className={`mt-[0.08em] inline-flex h-8 w-8 shrink-0 items-center justify-center rounded-full border text-[0.95rem] font-semibold leading-none transition sm:mt-[0.14em] sm:h-11 sm:w-11 sm:text-lg ${
                              isSelected
                          ...
                          <span className="block text-[0.95rem] font-medium leading-[1.55] text-black sm:text-[clamp(1.15rem,1.6vw,1.35rem)] sm:leading-[1.85]">
                            {choice}
                          </span>
                        </button>
                      );
